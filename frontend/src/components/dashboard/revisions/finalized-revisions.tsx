...
const FinalizedRevisions = () => {
  const { revisions, isLoading, refreshRevisions } = useFinalizedRevisions();
  ...
  return (
    <div className="w-full flex flex-col gap-6">
      <div className="flex w-full justify-between items-center border-b border-accent-100 py-2">
        <h1 className="text-2xl font-bold">Revisiones finalizadas</h1>
...
export default FinalizedRevisions;
